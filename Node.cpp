...
int main(int argc, char* argv[])
{
	...
	Node<std::string>::FuncDict for_upper_func_dict{}; 
	...
	Node<std::string>::FuncDict for_lower_func_dict{};
	...
	auto node_ptr = Node<std::string>::Create(service, server_port, buffer_size, 
	...
	auto core_ptr = node_ptr->GetCorePtr();
